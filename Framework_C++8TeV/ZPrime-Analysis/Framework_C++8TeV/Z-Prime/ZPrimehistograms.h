...
void ZPrimeAnalysis::define_histograms()
{
  ...
  hist_ZPrimeMass          = new TH1F("hist_ZPrimeMass",         "Transverse Mass; M^{Z'}_{T};Events", 40, 0, 3500);
  hist_FirstTwoJetsMass       = new TH1F("hist_FirstTwoJetsMass",      "Invariant Mass of Two Leading Jets; M^{2Jets}_{T};Events", 40, 0, 3500);
  hist_FirstThreeJetsMass       = new TH1F("hist_FirstThreeJetsMass",      "Invariant Mass of Three Leading Jets; M^{3Jets}_{T};Events", 40, 0, 3500);
...
void ZPrimeAnalysis::FillOutputList()
{
  ...
  //Mass histograms
  GetOutputList()->Add(hist_ZPrimeMass);
  GetOutputList()->Add(hist_FirstTwoJetsMass);
  GetOutputList()->Add(hist_FirstThreeJetsMass);
...
//Mass histograms
  if (s.Contains("hist_ZPrimeMass")) hist_ZPrimeMass->Fill(m,w);

  if (s.Contains("hist_FirstTwoJetsMass")) hist_FirstTwoJetsMass->Fill(m,w);

  if (s.Contains("hist_FirstThreeJetsMass")) hist_FirstThreeJetsMass->Fill(m,w);
